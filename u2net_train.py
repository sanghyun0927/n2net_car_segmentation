...
data_dir = os.path.join(os.getcwd(), 'train' + os.sep)
mask_dir = os.path.join(os.getcwd(), 'train_masks' + os.sep)
...
tra_img_name_list = glob.glob(data_dir + '*' + image_ext)  # + tra_image_dir
...
for img_path in tra_img_name_list:
	...
	tra_lbl_name_list.append(mask_dir + imidx + label_ext) # + tra_label_dir
